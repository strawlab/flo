...
mod osd_symbols {
    ...
    pub const SYM_OVER_HOME: u8 = 0x05;
    pub const SYM_STICK_OVERLAY_SPRITE_MID: u8 = 0x09;
    pub const SYM_M: u8 = 0x0c;
    pub const SYM_ARROW_SOUTH: u8 = 0x60;
    /// a crosshair
    pub const SYM_AH_CENTER: u8 = 0x73;
    ///progress bar pieces
    pub const SYM_PB_START: u8 = 0x8A;
    pub const SYM_PB_FULL: u8 = 0x8B;
    pub const SYM_PB_HALF: u8 = 0x8C;
    pub const SYM_PB_EMPTY: u8 = 0x8D;
    pub const SYM_PB_END: u8 = 0x8E;
    pub const SYM_PB_CLOSE: u8 = 0x8F;
...
pub fn arrow_char(dir: Angle) -> u8 {
